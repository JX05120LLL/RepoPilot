...
class AppSettings(BaseSettings):
    ...
    chat_fallback_base_url: str | None = Field(default=None, validation_alias="REPOPILOT_CHAT_FALLBACK_BASE_URL")
    chat_fallback_api_key: SecretStr | None = Field(default=None, validation_alias="REPOPILOT_CHAT_FALLBACK_API_KEY")
    chat_fallback_model: str | None = Field(default=None, validation_alias="REPOPILOT_CHAT_FALLBACK_MODEL")
    ...
    max_concurrent_tasks: int = Field(default=2, ge=1, le=32, validation_alias="REPOPILOT_MAX_CONCURRENT_TASKS")
